...
def test_make_image_prompt_pano_detection_modes():
    assert make_image_prompt("D", is_pano="auto")["is_pano"] == "auto"
    assert make_image_prompt("D", is_pano=True)["is_pano"] is True
    assert make_image_prompt("D", is_pano=False)["is_pano"] is False
